...
//   }
  ...
  // }
//   updateExpert(expert: Expert): Observable<Expert> {
//     return this.httpClient.put<Expert>(`${environment.apiUrl}/${this.url}/${expert.id}`, expert);
//   }
// }
import { HttpClient } from '@angular/common/http';
import { Injectable } from '@angular/core';
...
export class ExpertService {
  ...
  deleteExpert(expert: Expert): Observable<void> {
    return this.httpClient.delete<void>(`${environment.apiUrl}/${this.url}/${expert.id}`);
  }

  createExpert(expert: Expert): Observable<Expert> {
    return this.httpClient.post<Expert>(`${environment.apiUrl}/${this.url}`, expert);
  }
  ...
  getExpertById(id: number): Observable<Expert> {
    return this.httpClient.get<Expert>(`${environment.apiUrl}/${this.url}/${id}`);
  }
}
